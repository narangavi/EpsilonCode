...
<html>
<head><title><%= statusCode %> <%= StringEscapeUtils.escapeHtml4(message) %>
</title></head>
<body>
<h1><%= StringEscapeUtils.escapeHtml4(message) %>
</h1>
...
<hr>
<address><%= StringEscapeUtils.escapeHtml4(this.getServletConfig().getServletContext().getServerInfo()) %>
</address>
</body>
</html>
<%!
