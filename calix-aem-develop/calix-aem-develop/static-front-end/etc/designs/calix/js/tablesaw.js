...
;(function( win, $, undefined ){
	...
	function createSwipeTable( $table ){
		...
		function getNext(){
			var next = [],
				checkFound;
				// console.log('$headerCellsNoPersist Length',$headerCellsNoPersist.length - 1)
		...
		function advance( fwd ){
			...
			// reset startIndex, endIndex and count
			// var totalCount = $('.tablesaw-advance-dots > li').length - 1;
			// var startIndex = 1;
			// var endIndex = 4;
			// $headerCellsNoPersist.each(function(i,item){
			// console.log('ignore the rest of this stuff',$headerCellsNoPersist)
			  // if(i !== 0){
			    // if(item.className === '') {
			...
			//
			// });
			// $('.bleh').html(startIndex);
			// $('.grr').html(endIndex);
			// $('.fuck').html(totalCount);
		}
		// $headerCellsNoPersist.append('<div>'+startIndex+'</div>')
...
;(function( win, $, undefined ){
	...
	function createMiniMap( $table ){
		...
		$table
			...
			// totalCount =  $dotNav.find( "li" ).length;
			// startIndex = 1;
			// endIndex = 4;
			//
			// $('.bleh').html(startIndex);
